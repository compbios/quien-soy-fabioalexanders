...
# ¿Cuáles son mis intereses académicos? :technologist:
...
- Análisis multivariados[^1]. 
# ¿Cuál ha sido mi experiencia?
## Instituto Nacional de Cancerología
1. Participación en diseño y realización de un **experimento clínico aleatorizado**[^2].
2. Validación de escalas para la medición de calidad de vida en pacientes con cáncer
3. Evaluación de la relación entre calidad de vida, el apoyo social y la sobrecarga del cuidador.
## Instituto de Evaluación Tecnológica en Salud (IETS)
- Elaboración de *revisiones sistemáticas de la literatura*.
- Elaboración de *guías de práctica clínica*.
- Elaboración de protocolos y lineamientos clínicos.
## Docencia
